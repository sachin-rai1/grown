...
//
//     final modelPccUpdate = modelPccUpdateFromJson(jsonString);

import 'dart:convert';

ModelPccUpdate modelPccUpdateFromJson(String str) => ModelPccUpdate.fromJson(json.decode(str));

String modelPccUpdateToJson(ModelPccUpdate data) => json.encode(data.toJson());

class ModelPccUpdate {
  String? loadAmpAcb;
  String? loadAmpMfm;
  ...
  factory ModelPccUpdate.fromJson(Map<String, dynamic> json) => ModelPccUpdate(
