  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor:(departmentName.value != "Admin")?Colors.transparent:Colors.blue,
        title: (departmentName.value != "Admin")?const Text(""):const Text("Employee Management"),
        centerTitle: true,
        elevation: 0,
      ),
      body: (departmentName.value == "Admin") ? GridView(
        ...
        children: List.generate(controller.choices.length, (index) {
          ...
          : (departmentName.value == "Lab") ? LabEmployeeManagementView()
          : (departmentName.value == "IT") ? const ItEmployeeManagementView()
          : (departmentName.value == "GAS") ?const GasEmployeeManagementView():Container(),
    );
  }
}
