...
class ViewComplainView extends GetView<ViewComplainController> {
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                            ...
                                            child: Padding(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  IconButton(
                                                    onPressed: () {
                                                      openEditDialog(
                                                        ...
                                                        problemDescription: controller.complainsDataList[index].problemDescription!,
                                                        problems: controller.complainsDataList[index].problems!,
                                                        photos: controller.complainsDataList[index].photos!,
                                                  ...
                                                  IconButton(
                                                    onPressed: () {
                                                      deleteComplain(context: context, complainId: controller.complainsDataList[index].complainId!,);
                                                    },
                                                    icon: const Icon(
                                                        Icons.delete),
                                                    color: Colors.red,
                                          ...
                                          MyTextWidget(
                                            title: "Date",
                                            body: controller.complainsDataList[index].createdOn!,
                                            isLines: false,
                                          ),
                                          MyTextWidget(
                                            title: "Ticket No",
                                          ...
                                          Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                (controller.complainsDataList[index].problems!.isEmpty)?Container(): Column(
                                                   crossAxisAlignment: CrossAxisAlignment.start,
                                                  children: [
                                                    Card(
                                                          ...
                                                          child: Container(
                                                            ...
                                                            child: Padding(
                                                                padding:
                                                                    const EdgeInsets
                                                                        .all(8.0),
                                                                child: Text(controller.complainsDataList[index].problems![problemIndex],
                                                ...
                                                (controller.complainsDataList[index].problemDescription == '')?Container(): Column(
                                                  crossAxisAlignment: CrossAxisAlignment.start,
                                                  children: [
                                                    Card(
                                                      margin: const EdgeInsets.only(
                                                ...
                                                Obx(
                                                  () => (controller.complainsDataList[index].engineers!.isEmpty)
                                                      ? const Padding(
                                                          padding:
                                                              EdgeInsets.all(
                                                                  8.0),
                                                      ...
                                                      : ListView.builder(
                                                          ...
                                                          shrinkWrap: true,
                                                          itemCount: controller.complainsDataList[index].engineers!.length,
                                                          itemBuilder: (context, engineerIndex) {
                                                            return Padding(
                                                              ...
                                                              child: Container(
                                                                ...
                                                                child: Padding(
                                                                    padding: const EdgeInsets.all(8.0),
                                                                    child: Text(controller.complainsDataList[index].engineers![engineerIndex].toString(),
  ...
  void deleteComplain({required BuildContext context, required int complainId}) {
  ...
  void openEditDialog({required BuildContext context,required int complainId, required int index , required String machineName , required String machineNo , required String problemDescription , required List<String> problems , required List<String> photos}) {
                                ...
                                return CheckboxListTile(
                                  ...
                                  onChanged: (value) {
                                    ...
                                    if (checkList[index] == true) {
                                      controller.problem.add(controller.problemsDataList[index].description!);
                                    }
