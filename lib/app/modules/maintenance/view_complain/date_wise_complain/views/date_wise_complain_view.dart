...
class DateWiseComplainView extends GetView<DateWiseComplainController> {
  DateWiseComplainView({Key? key}) : super(key: key);
  final dateWiseComplainController = Get.put(DateWiseComplainController());
                  ...
                  children: [
                    MyDateWidget(
                      onChanged: (val) {
                        ...
                        controller.getComplains(selectedDate: controller.formatted);
                      },
                    ...
                    Padding(
                      ...
                      child: Align(
                          ...
                          child: IconButton(onPressed: (){
                            convertToExcel(jsonList: controller.jsonList,fileName: "DateWiseComplain", jsonKey: "complain");
