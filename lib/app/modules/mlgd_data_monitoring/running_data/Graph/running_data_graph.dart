...
class RunningDataGraph extends GetView<ViewMlgdDataRunWiseController> {
  RunningDataGraph({super.key});

  final viewMlgdDataRunWiseController =
      Get.put(ViewMlgdDataRunWiseController());
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                      ...
                      constraints:
                          BoxConstraints(maxHeight: 40, maxWidth: w / 2),
                        ...
                        series: [
                          LineSeries<MlgdData, dynamic>(
                            ...
                            xValueMapper: (MlgdData dataProcess, _) =>
                                controller.changeDateTimeFormat(
                                    dataProcess.createdOn!),
                          ...
                          LineSeries<MlgdData, dynamic>(
                            ...
                            xValueMapper: (MlgdData dataProcess, _) =>
                                controller.changeDateTimeFormat(
                                    dataProcess.createdOn!),
                            yValueMapper: (MlgdData dataProcess, _) =>
                                dataProcess.cleanPcsNo! /
                                dataProcess.totalPcsNo! *
                                100,
                          ),
                        ],
                      );
