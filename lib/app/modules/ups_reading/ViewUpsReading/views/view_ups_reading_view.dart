...
class ViewUpsReadingView extends GetView<ViewUpsReadingController> {
  ViewUpsReadingView({Key? key}) : super(key: key);
  final viewUpsReadingController = Get.put(ViewUpsReadingController());
